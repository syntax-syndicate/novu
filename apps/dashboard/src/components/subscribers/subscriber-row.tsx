...
const SubscriberLinkTableCell = (props: SubscriberLinkTableCellProps) => {
  ...
  return (
    <TableCell className={cn('group-hover:bg-neutral-alpha-50 text-foreground-600 relative', className)} {...rest}>
      {children}
    </TableCell>
  );
};
      ...
      <SubscriberLinkTableCell subscriber={subscriber}>
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <TruncatedText className="text-foreground-950 max-w-[32ch] font-medium">
